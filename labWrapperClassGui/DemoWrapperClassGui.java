...
public class DemoWrapperClassGui extends JFrame {
    ...
    private void createContentPane() {
        ...
        contentPane.add(numberTextArea, BorderLayout.CENTER);
         ...
         contentPane.add(charArea, BorderLayout.CENTER);
    }
    ...
    private void createNumberControlPanel() {
        ...
        //minmax button
        radioMinMax = new JRadioButton("Min Max");
        radioMinMax.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		numberTextArea.setText(dwc.minMax());
        	}
        });
        buttonGroup_1.add(radioMinMax);
        numberControlPanel.add(radioMinMax);
        
        // binary button
        radioBinary = new JRadioButton("Binary Oct Hex");	
        ...
        buttonGroup_1.add(radioBinary);
        numberControlPanel.add(radioBinary);
    }

    private void createCharArea() {
        charArea = new JTextArea("Char");
        charArea.setMargin(new Insets(30, 30, 30, 30));
        charArea.setForeground(new Color(255, 255, 255));
        charArea.setOpaque(true);
        charArea.setBackground(new Color(220, 20, 60));
        charArea.setFont(new Font("Verdana", Font.PLAIN, 40));
    }
    		// Character Tab
    private void createCharControlPanel() {
        ...
        charField = new JTextField("Submit");
        charField.setPreferredSize(new Dimension(150, 28));
        charField.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		char[] charString = charField.getText().toCharArray();
        		charArea.setText(dwc2.charProperties(charString[0]));
        	}
        });
        charControlPanel.add(charField);
    }
